 ...
 * ancestry)`). Separated from loadTaxaDb() so the query logic can be exercised against an
...
export async function loadTaxaDb() {
    ...
    return createTaxaAccessor(new Database(DB_FILE, { readonly: true }));
}
