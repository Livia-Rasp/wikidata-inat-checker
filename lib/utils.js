 ...
 * @param {string[]} values
 * @param {{ valueProperty: string, absentProperty?: string | null, valueKey: string, sparqlPostFn?: (q: string) => Promise<object[]>, batchSize?: number, iucnQid?: string | null, onBatch?: (done: number, total: number) => void }} opts
 ...
 * @param {{ valueProperty: string, absentProperty?: string | null, valueKey: string, sparqlFn?: (q: string) => Promise<object[]> }} opts
